...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-25 00:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e826ab89-b3e3-47f0-8994-d4d77a190393.git
$ cd e826ab89-b3e3-47f0-8994-d4d77a190393
```
